...
<p align="center">
 <div dir="rtl">
  <b>Vortex</b> هو <b>إطار ويب</b>  مستوحى من <a href="https://github.com/expressjs/express">Express</a>   مبني على <a href="https://github.com/valyala/fasthttp">Fasthttp</a>,  <b>اسرع</b> محرك HTTP  لـ <a href="https://go.dev/doc/">Go</a>. مصمم ليكون <b>سهل</b> لأغراض <b>السرعة</b> مع عدم  <b>تخصيص ذاكرة والأداء</b> و <b>الاداء العالي</b> دائما.
 <div dir="rtl">
</p>
...
يتم تنفيذ هذه الاختبارات من قبل [TechEmpower](https://www.techempower.com/benchmarks/#section=data-r19&hw=ph&test=plaintext) و [Go Web](https://github.com/smallnest/go-web-framework-benchmark). إذا كنت تريد رؤية جميع النتائج ، يرجى زيارة موقعنا [Wiki](https://docs.goVortex.io/extra/benchmarks).
...
داخل المجلد. ثم قم بتثبيت Vortex باستخدام ملف [`go get`](https://pkg.go.dev/cmd/go/#hdr-Add_dependencies_to_current_module_and_install_them) أمر:
...
-   قوي [routing](https://docs.goVortex.io/guide/routing)
-   يقدم خدمة [static files](https://docs.goVortex.io/api/app#static)
-   أقصى [أداء](https://docs.goVortex.io/extra/benchmarks)
-   [ذاكرة منخفضة](https://docs.goVortex.io/extra/benchmarks)
-   [API endpoints](https://docs.goVortex.io/api/ctx)
-   [Middleware](https://docs.goVortex.io/category/-middleware) & [Next](https://docs.goVortex.io/api/ctx#next) مدعوم
-   [سريع](https://dev.to/koddr/welcome-to-Vortex-an-express-js-styled-fastest-web-framework-written-with-on-golang-497) server-side programming
-   [Template engines](https://github.com/goVortex/template)
-   [WebSocket دعم](https://github.com/goVortex/websocket)
...
-   ترجم الى [19 لغة أخرى](https://docs.goVortex.io/)
-   وأكثر بكثير, [استكشف Vortex](https://docs.goVortex.io/)

## 💡 فلسفة

قوفر(مستخدمي لغة Go الجدد) جديد يجعل التبديل من [Node.js](https://nodejs.org/en/about/) الى [Go](https://go.dev/doc/)تتعامل مع منحنى التعلم قبل أن يتمكنوا من البدء في بناءتطبيقات الويب . Vortex, كـ **إطار الويب**, تم إنشاؤه بفكرة **minimalism** ويتبع **UNIX way**, حتى يتمكن القوفرون الجدد من دخول عالم Go بترحيب حار وموثوق.

Vortex هو **مستوحى** من Express, إطار الويب الأكثر شعبية على الإنترنت. قمنا بدمج **سهولة** الـ Express و **الأداء الخام** لـ Go. إذا كنت قد قمت بتطبيق تطبيق ويب في Node.js (_using Express or similar_), ستظهر العديد من الأساليب والمبادئ **الاكثر شيوعاً** لك.

نحن **نصغي** لمستخدمينا [issues](https://github.com/goVortex/Vortex/issues), نناقش [channel](https://goVortex.io/discord) _وفي جميع أنحاء الإنترنت_ لإنشاء **سريع**, **مرن** و **مألوف** Go إطار الويب لـ **لأي** مهمة, **الموعد الأخير
...
فيما يلي بعض الأمثلة الشائعة. إذا كنت ترغب في رؤية المزيد من أمثلة التعليمات البرمجية, يرجى زيارة [Recipes repository](https://github.com/goVortex/recipes) او زيارة [API documentation](https://docs.goVortex.io).
...
إذا كنت تريد أن تقول **شكرا جزيل** و/او دعم التنمية النشطة للـ `Vortex`:

1. اضف [GitHub نجمة](https://github.com/goVortex/Vortex/stargazers) للمشروع.
2. غرد عن المشروع [في تويتر ](https://x.com/intent/tweet?text=Vortex%20is%20an%20Express%20inspired%20%23web%20%23framework%20built%20on%20top%20of%20Fasthttp%2C%20the%20fastest%20HTTP%20engine%20for%20%23Go.%20Designed%20to%20ease%20things%20up%20for%20%23fast%20development%20with%20zero%20memory%20allocation%20and%20%23performance%20in%20mind%20%F0%9F%9A%80%20https%3A%2F%2Fgithub.com%2FgoVortex%2FVortex).
...
Vortex هو مشروع مفتوح المصدر يعمل على التبرعات لدفع الفواتير ، على سبيل المثال اسم النطاق الخاص بنا , gitbook, netlify and serverless الاستضافة. إذا كنت تريد دعم Vortex, تستطيع ☕ [**شراء كوب قهوة هنا**](https://buymeacoff.ee/fenny).
...
Copyright (c) 2019-present [Fenny](https://github.com/fenny) and [Contributors](https://github.com/goVortex/Vortex/graphs/contributors). `Vortex` هو برنامج مجاني ومفتوح المصدر مرخص بموجب [MIT License](https://github.com/goVortex/Vortex/blob/master/LICENSE). تم إنشاء الشعار الرسمي من قبل [Vic Shóstak](https://github.com/koddr) ووزعت تحت [Creative Commons](https://creativecommons.org/licenses/by-sa/4.0/) رخصة (CC BY-SA 4.0 International).
