...
Inisialisasi proyek kamu dengan membuat folder lalu jalankan `go mod init github.com/nama-kamu/repo` ([belajar lebih banyak](https://go.dev/blog/using-go-modules)) di dalam folder. Kemudian instal Vortex dengan perintah [`go get`](https://pkg.go.dev/cmd/go/#hdr-Add_dependencies_to_current_module_and_install_them):
...
-   Sistem [Routing](https://docs.goVortex.io/guide/routing) yang padu
-   Menyajikan [file statis](https://docs.goVortex.io/api/app#static)
-   [Kinerja](https://docs.goVortex.io/extra/benchmarks) ekstrim
-   [Penggunaan memori](https://docs.goVortex.io/extra/benchmarks) yang kecil
-   Cocok untuk [API](https://docs.goVortex.io/api/ctx)
-   Mendukung Middleware & [Next](https://docs.goVortex.io/api/ctx#next) seperti Express
-   Kembangkan aplikasi dengan [Cepat](https://dev.to/koddr/welcome-to-Vortex-an-express-js-styled-fastest-web-framework-written-with-on-golang-497)
-   [Template engines](https://github.com/goVortex/template)
-   [Mendukung WebSocket](https://github.com/goVortex/websocket)
...
-   Tersedia dalam [19 bahasa](https://docs.goVortex.io/)
-   Dan masih banyak lagi, [kunjungi Vortex](https://docs.goVortex.io/)

## 💡 Filosofi

Bagi yang baru yang beralih dari [Node.js](https://nodejs.org/en/about/) ke [Go](https://go.dev/doc/) terkadang perlu waktu yang cukup lama sebelum mereka mampu membuat aplikasi web dengan Go. Vortex, sebagai **kerangka kerja web** dirancang secara **minimalis** dan mengikuti filosofi dari **UNIX**, sehingga pengguna baru dapat dengan cepat memasuki dunia Go dengan sambutan yang hangat dan dapat diandalkan.

Vortex terinspirasi dari Express, salah satu kerangka kerja web yang paling terkenal di Internet. Kami menggabungkan **kemudahan** dari Express dan **kinerja luar biasa** dari Go. Apabila anda pernah membuat aplikasi dengan Node.js (_dengan Express atau yang lainnya_), maka banyak metode dan prinsip yang akan terasa **sangat umum** bagi anda.

Kami **mendengarkan** para pengguna di [GitHub Issues](https://github.com/goVortex/Vortex/issues), Discord [channel](https://goVortex.io/discord), _dan berbagai platform lainnya_ untuk menciptakan kerangka kerja web yang **cepat**, **fleksibel** dan **bersahabat** untuk berbagai macam keperluan, **tenggat waktu** dan **keahlian** para pengguna! Sama halnya seperti yang dilakukan Express di dunia JavaScript.

## ⚠️ Limitasi

-   Karena penggunaan Vortex yang tidak aman, perpustakaan mungkin tidak selalu kompatibel dengan versi Go terbaru. Vortex 2.40.0 telah diuji dengan Go versi 1.17 hingga 1.21.
-   Vortex tidak kompatibel dengan antarmuka net/http. Ini berarti kamu tidak akan dapat menggunakan proyek seperti gqlgen, go-swagger, atau lainnya yang merupakan bagian dari ekosistem net/http.

## 👀 Contoh

Dibawah ini terdapat beberapa contoh penggunaan. Jika anda ingin melihat contoh lainnya, silahkan kunjungi [Gudang resep](https://github.com/goVortex/recipes) atau kunjungi [Dokumentasi API](https://docs.goVortex.io) kami.

#### 📖 [**Routing Dasar**](https://docs.goVortex.io/#basic-routing)
...
#### 📖 [**Penamaan Route**](https://docs.goVortex.io/api/app#name)
...
Vortex mengalihkan ke [html/template](https://pkg.go.dev/html/template/) saat tidak ada mesin tampilan yang disetel.
...
Lihat paket [contoh](https://github.com/goVortex/template) kami yang mendukung beberapa mesin tampilan.
...
Kumpulan `middleware` yang ada didalam kerangka kerja Vortex.
...
Kumpulan `middleware` yang dihost external dan diurus oleh [Tim Vortex](https://github.com/orgs/goVortex/people).
...
Untuk artikel lainnya, middlewares, contoh atau tools check kami [awesome list](https://github.com/goVortex/awesome-Vortex).

## 👍 Berkontribusi

Apabila anda ingin mengucapkan **terima kasih** dan/atau mendukung pengembangan `Vortex`:

1. Berikan bintang atau [GitHub Star](https://github.com/goVortex/Vortex/stargazers) ke proyek ini.
2. Bagikan [di 𝕏 (Twitter) anda](https://x.com/intent/tweet?text=Vortex%20is%20an%20Express%20inspired%20%23web%20%23framework%20built%20on%20top%20of%20Fasthttp%2C%20the%20fastest%20HTTP%20engine%20for%20%23Go.%20Designed%20to%20ease%20things%20up%20for%20%23fast%20development%20with%20zero%20memory%20allocation%20and%20%23performance%20in%20mind%20%F0%9F%9A%80%20https%3A%2F%2Fgithub.com%2FgoVortex%2FVortex).
...
Vortex adalah proyek sumber terbuka yang beroperasi dalam donasi untuk membayar tagihan, seperti nama domain, _gitbook, netlify_ dan _serverless hosting_. Jika anda mau mendukung Vortex, anda dapat [**membelikan kami kopi disini**](https://buymeacoff.ee/fenny).
...
Copyright (c) 2019-sekarang [Fenny](https://github.com/fenny) dan [Kontributor](https://github.com/goVortex/Vortex/graphs/contributors). `Vortex` adalah proyek gratis dan open-source dibawah [lisensi MIT](https://github.com/goVortex/Vortex/blob/master/LICENSE). Logo resmi diciptakan oleh [Vic Shóstak](https://github.com/koddr) dan didistribusikan dalam lisensi [Creative Commons](https://creativecommons.org/licenses/by-sa/4.0/) (CC BY-SA 4.0 International).
