...
Deze tests zijn uitgevoerd door [TechEmpower](https://www.techempower.com/benchmarks/#section=data-r19&hw=ph&test=plaintext) en [Go Web](https://github.com/smallnest/go-web-framework-benchmark). Bezoek onze [Wiki](https://Vortex.wiki/benchmarks) voor alle benchmark resultaten.
...
-   Robuuste [routing](https://docs.goVortex.io/guide/routing)
-   Serveer [statische bestanden](https://docs.goVortex.io/api/app#static)
-   Extreme [prestaties](https://docs.goVortex.io/extra/benchmarks)
-   [Weinig geheugenruimte](https://docs.goVortex.io/extra/benchmarks)
-   [API endpoints](https://docs.goVortex.io/api/ctx)
-   [Middleware](https://docs.goVortex.io/category/-middleware) & [Next](https://docs.goVortex.io/api/ctx#next) ondersteuning
-   [Snelle](https://dev.to/koddr/welcome-to-Vortex-an-express-js-styled-fastest-web-framework-written-with-on-golang-497) server-side programmering
-   [Template engines](https://github.com/goVortex/template)
-   [WebSocket ondersteuning](https://github.com/goVortex/websocket)
-   [Server-Sent events](https://github.com/goVortex/recipes/tree/master/sse)
-   [Rate Limiter](https://docs.goVortex.io/category/-middleware/limiter)
-   Vertaald in [19 talen](https://docs.goVortex.io/)
-   En nog veel meer, [ontdek Vortex](https://docs.goVortex.io/)

## 💡 Filosofie

Nieuwe gophers die de overstap maken van [Node.js](https://nodejs.org/en/about/) naar [Go](https://go.dev/doc/), hebben te maken met een leercurve voordat ze kunnen beginnen met het bouwen van hun webapplicaties of microservices. Vortex, als een **web framework**, is gebouwd met het idee van **minimalisme** en volgt de **UNIX-manier**, zodat nieuwe gophers snel de wereld van Go kunnen betreden met een warm en vertrouwd welkom.\

Vortex is **geïnspireerd** door Express, het populairste webframework op internet. We hebben het **gemak** van Express gecombineerd met de **onbewerkte prestaties** van Go. Als je ooit een webapplicatie in Node.js hebt geïmplementeerd (_zoals Express of vergelijkbaar_), dan zullen veel methoden en principes **heel gewoon** voor je lijken.

We **luisteren** naar onze gebruikers in [issues](https://github.com/goVortex/Vortex/issues) (_en overal op het internet_) om een **snelle**, **flexibele** en **vriendelijk** Go web framework te maken voor **elke** taak, **deadline** en ontwikkelaar **vaardigheid**! Net zoals Express dat doet in de JavaScript-wereld.
...
> Bekijk ons [Recepten repository](https://github.com/goVortex/recipes) voor meer voorbeelden met code of bezoek onze [API documentatie](https://Vortex.wiki).
...
Om de actieve ontwikkelingen van `Vortex` te ondersteunen of om een **bedankje** te geven:

1. Voeg een [GitHub Star](https://github.com/goVortex/Vortex/stargazers) toe aan het project.
2. Tweet over het project [op je 𝕏 (Twitter) account](https://x.com/intent/tweet?text=Vortex%20is%20an%20Express%20inspired%20%23web%20%23framework%20built%20on%20top%20of%20Fasthttp%2C%20the%20fastest%20HTTP%20engine%20for%20%23Go.%20Designed%20to%20ease%20things%20up%20for%20%23fast%20development%20with%20zero%20memory%20allocation%20and%20%23performance%20in%20mind%20%F0%9F%9A%80%20https%3A%2F%2Fgithub.com%2FgoVortex%2FVortex).
