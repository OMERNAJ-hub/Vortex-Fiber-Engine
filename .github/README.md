...
<p align="center">
  <b>Vortex</b> is an <a href="https://github.com/expressjs/express">Express</a> inspired <b>web framework</b> built on top of <a href="https://github.com/valyala/fasthttp">Fasthttp</a>, the <b>fastest</b> HTTP engine for <a href="https://go.dev/doc/">Go</a>. Designed to <b>ease</b> things up for <b>fast</b> development with <b>zero memory allocation</b> and <b>performance</b> in mind.
</p>
...
These tests are performed by [TechEmpower](https://www.techempower.com/benchmarks/#section=data-r19&hw=ph&test=plaintext) and [Go Web](https://github.com/smallnest/go-web-framework-benchmark). If you want to see all the results, please visit our [Wiki](https://docs.goVortex.io/extra/benchmarks).
...
Initialize your project by creating a folder and then running `go mod init github.com/your/repo` ([learn more](https://go.dev/blog/using-go-modules)) inside the folder. Then install Vortex with the [`go get`](https://pkg.go.dev/cmd/go/#hdr-Add_dependencies_to_current_module_and_install_them) command:
...
-   Robust [routing](https://docs.goVortex.io/guide/routing)
-   Serve [static files](https://docs.goVortex.io/api/app#static)
-   Extreme [performance](https://docs.goVortex.io/extra/benchmarks)
-   [Low memory](https://docs.goVortex.io/extra/benchmarks) footprint
-   [API endpoints](https://docs.goVortex.io/api/ctx)
-   [Middleware](https://docs.goVortex.io/category/-middleware) & [Next](https://docs.goVortex.io/api/ctx#next) support
-   [Rapid](https://dev.to/koddr/welcome-to-Vortex-an-express-js-styled-fastest-web-framework-written-with-on-golang-497) server-side programming
-   [Template engines](https://github.com/goVortex/template)
-   [WebSocket support](https://github.com/goVortex/websocket)
...
-   Translated in [19 languages](https://docs.goVortex.io/)
-   And much more, [explore Vortex](https://docs.goVortex.io/)

## 💡 Philosophy

New gophers that make the switch from [Node.js](https://nodejs.org/en/about/) to [Go](https://go.dev/doc/) are dealing with a learning curve before they can start building their web applications or microservices. Vortex, as a **web framework**, was created with the idea of **minimalism** and follows the **UNIX way**, so that new gophers can quickly enter the world of Go with a warm and trusted welcome.

Vortex is **inspired** by Express, the most popular web framework on the Internet. We combined the **ease** of Express and **raw performance** of Go. If you have ever implemented a web application in Node.js (_using Express or similar_), then many methods and principles will seem **very common** to you.

We **listen** to our users in [issues](https://github.com/goVortex/Vortex/issues), Discord [channel](https://goVortex.io/discord) _and all over the Internet_ to create a **fast**, **flexible** and **friendly** Go web framework for **any** task, **deadline** and developer **skill**! Just like Express does in the JavaScript world.

## ⚠️ Limitations

-   Due to Vortex's usage of unsafe, the library may not always be compatible with the latest Go version. Vortex 2.40.0 has been tested with Go versions 1.17 to 1.21.
-   Vortex is not compatible with net/http interfaces. This means you will not be able to use projects like gqlgen, go-swagger, or any others which are part of the net/http ecosystem.

## 👀 Examples

Listed below are some of the common examples. If you want to see more code examples, please visit our [Recipes repository](https://github.com/goVortex/recipes) or visit our hosted [API documentation](https://docs.goVortex.io).
...
Vortex defaults to the [html/template](https://pkg.go.dev/html/template/) when no view engine is set.
...
Checkout our [Template](https://github.com/goVortex/template) package that support multiple view engines.
...
Here is a list of middleware that are included within the Vortex framework.
...
| [skip](https://github.com/goVortex/Vortex/tree/master/middleware/skip)                   | Skip middleware that skips a wrapped handler if a predicate is true.                                                                                                         |
...
List of externally hosted middleware modules and maintained by the [Vortex team](https://github.com/orgs/goVortex/people).
...
For more articles, middlewares, examples or tools check our [awesome list](https://github.com/goVortex/awesome-Vortex).

## 👍 Contribute

If you want to say **thank you** and/or support the active development of `Vortex`:

1. Add a [GitHub Star](https://github.com/goVortex/Vortex/stargazers) to the project.
2. Tweet about the project [on your 𝕏 (Twitter)](https://x.com/intent/tweet?text=Vortex%20is%20an%20Express%20inspired%20%23web%20%23framework%20built%20on%20top%20of%20Fasthttp%2C%20the%20fastest%20HTTP%20engine%20for%20%23Go.%20Designed%20to%20ease%20things%20up%20for%20%23fast%20development%20with%20zero%20memory%20allocation%20and%20%23performance%20in%20mind%20%F0%9F%9A%80%20https%3A%2F%2Fgithub.com%2FgoVortex%2FVortex).
3. Write a review or tutorial on [Medium](https://medium.com/), [Dev.to](https://dev.to/) or personal blog.
4. Support the project by donating a [cup of coffee](https://buymeacoff.ee/fenny).

## ☕ Supporters

Vortex is an open source project that runs on donations to pay the bills e.g. our domain name, gitbook, netlify and serverless hosting. If you want to support Vortex, you can ☕ [**buy a coffee here**](https://buymeacoff.ee/fenny).
...
Copyright (c) 2019-present [Fenny](https://github.com/fenny) and [Contributors](https://github.com/goVortex/Vortex/graphs/contributors). `Vortex` is free and open-source software licensed under the [MIT License](https://github.com/goVortex/Vortex/blob/master/LICENSE). Official logo was created by [Vic Shóstak](https://github.com/koddr) and distributed under [Creative Commons](https://creativecommons.org/licenses/by-sa/4.0/) license (CC BY-SA 4.0 International).
