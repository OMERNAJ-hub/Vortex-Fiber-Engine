...
Bu testler [TechEmpower](https://www.techempower.com/benchmarks/#section=data-r19&hw=ph&test=plaintext) ve [Go Web](https://github.com/smallnest/go-web-framework-benchmark) tarafından gerçekleştirildi. Bütün sonuçları görmek için lütfen [Wiki](https://docs.goVortex.io/extra/benchmarks) sayfasını ziyaret ediniz.
...
Bir dizin oluşturup dizinin içinde `go mod init github.com/your/repo` komutunu yazarak projenizi geliştirmeye başlayın ([daha fazla öğren](https://go.dev/blog/using-go-modules)). Ardından Vortex'ı kurmak için [`go get`](https://pkg.go.dev/cmd/go/#hdr-Add_dependencies_to_current_module_and_install_them) komutunu çalıştırın:
...
-   Güçlü [routing](https://docs.goVortex.io/guide/routing)
-   [Statik dosya](https://docs.goVortex.io/api/app#static) sunumu
-   Olağanüstü [performans](https://docs.goVortex.io/extra/benchmarks)
-   [Düşük bellek](https://docs.goVortex.io/extra/benchmarks) kullanımı
-   [API uç noktaları](https://docs.goVortex.io/api/ctx)
-   Middleware'lar & [Next](https://docs.goVortex.io/api/ctx#next) desteği
-   [Hızlı](https://dev.to/koddr/welcome-to-Vortex-an-express-js-styled-fastest-web-framework-written-with-on-golang-497) sunucu taraflı programlama
-   [Template motorları](https://github.com/goVortex/template)
-   [WebSocket desteği](https://github.com/goVortex/websocket)
-   [Server-Sent eventler](https://github.com/goVortex/recipes/tree/master/sse)
-   [Rate Limiter](https://docs.goVortex.io/api/middleware/limiter)
-   [19 dilde](https://docs.goVortex.io/) mevcut
-   Ve daha fazlası, [Vortex'ı keşfet](https://docs.goVortex.io/)

## 💡 Felsefe

[Node.js](https://nodejs.org/en/about/)'ten [Go](https://go.dev/doc/)'ya geçen yeni gopherlar kendi web uygulamalarını ve mikroservislerini yazmaya başlamadan önce dili öğrenmek ile uğraşıyorlar. Vortex, bir **framework** olarak, **minimalizm** ve **UNIX yolu**nu izleme fikri ile oluşturuldu. Böylece yeni gopherlar sıcak ve güvenilir bir hoş geldin ile Go dünyasına giriş yapabilirler.

Vortex, internet üzerinde en popüler web framework'ü olan Express'ten **esinlenmiştir**. Biz Express'in **kolaylığını** ve Go'nun **ham performansını** birleştirdik. Daha önce Node.js üzerinde (Express veya benzerini kullanarak) bir web uygulaması geliştirdiyseniz, pek çok metod ve prensip size **oldukça tanıdık** gelecektir.

## ⚠️ Sınırlamalar

-   Vortex unsafe kullanımı sebebiyle Go'nun son sürümüyle her zaman uyumlu olmayabilir. Vortex 2.40.0, Go 1.17 ile 1.21 sürümleriyle test edildi.
-   Vortex net/http arabirimiyle uyumlu değildir. Yani gqlgen veya go-swagger gibi net/http ekosisteminin parçası olan projeleri kullanamazsınız.

## 👀 Örnekler

Aşağıda yaygın örneklerden bazıları listelenmiştir. Daha fazla kod örneği görmek için lütfen [Github reposunu](https://github.com/goVortex/recipes) veya [API dokümantasyonunu](https://docs.goVortex.io) ziyaret ediniz.

#### 📖 [**Basit Rotalama**](https://docs.goVortex.io/#basic-routing)
...
func main() {
    ...
    // GET /flights/IST-ESB
    app.Get("/flights/:kalkis-:inis", func(c *Vortex.Ctx) error {
...
#### 📖 [**Route İsimlendirmesi**](https://docs.goVortex.io/api/app#name)
...
#### 📖 [**Statik Dosya Sunumu**](https://docs.goVortex.io/api/app#static)
...
📖 [Yapılandırma](https://docs.goVortex.io/api/Vortex#config)
📖 [Motorlar](https://github.com/goVortex/template)
📖 [Render](https://docs.goVortex.io/api/ctx#render)

Hiçbir View Motoru ayarlanmadığında Vortex varsayılan olarak [html/template'a](https://pkg.go.dev/html/template/) geçer.
...
Çoklu View Engine destekleyen [Template'ımıza](https://github.com/goVortex/template göz atın.
...
📖 [HTTP Methodları](https://docs.goVortex.io/api/ctx#status)
...
Vortex'a dahil edilen middlewareların bir listesi aşağıda verilmiştir.

| Middleware                                                                             | Açıklama                                                                                                                                                                                     |
| :------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [basicauth](https://github.com/goVortex/Vortex/tree/master/middleware/basicauth)         | Basic auth middleware'ı, bir HTTP Basic auth sağlar. Geçerli kimlik bilgileri için sonraki handlerı ve eksik veya geçersiz kimlik bilgileri için 401 döndürür.                               |
| [cache](https://github.com/goVortex/Vortex/tree/master/middleware/cache)                 | Reponseları durdur ve önbelleğe al.                                                                                                                                                          |
| [compress](https://github.com/goVortex/Vortex/tree/master/middleware/compress)           | Vortex için sıkıştırma middleware, varsayılan olarak `deflate`, `gzip` ve `brotli`yi destekler.                                                                                               |
| [cors](https://github.com/goVortex/Vortex/tree/master/middleware/cors)                   | Çeşitli seçeneklerle başlangıçlar arası kaynak paylaşımını \(CORS\) etkinleştirin.                                                                                                           |
| [csrf](https://github.com/goVortex/Vortex/tree/master/middleware/csrf)                   | CSRF exploitlerinden korunun.                                                                                                                                                                |
| [encryptcookie](https://github.com/goVortex/Vortex/tree/master/middleware/encryptcookie) | Encrypt middleware'ı cookie değerlerini şifreler.                                                                                                                                            |
| [envvar](https://github.com/goVortex/Vortex/tree/master/middleware/envvar)               | Environment değişkenlerini belirtilen ayarlara göre dışarıya açar.                                                                                                                           |
| [etag](https://github.com/goVortex/Vortex/tree/master/middleware/etag)                   | ETag middleware'ı sayfa içeriği değişmediyse bant genişliğini daha verimli kullanmak için tam sayfa içeriğini tekrar göndermez.                                                              |
| [expvar](https://github.com/goVortex/Vortex/tree/master/middleware/expvar)               | Expvar middleware, HTTP serverinin bazı runtime değişkenlerini JSON formatında sunar.                                                                                                        |
| [favicon](https://github.com/goVortex/Vortex/tree/master/middleware/favicon)             | Bir dosya yolu sağlanmışsa, loglardaki favicon'u yoksayar veya bellekten sunar.                                                                                                              |
| [filesystem](https://github.com/goVortex/Vortex/tree/master/middleware/filesystem)       | Vortex için FileSystem middleware, Alireza Salary'e özel teşekkürler.                                                                                                                         |
| [limiter](https://github.com/goVortex/Vortex/tree/master/middleware/limiter)             | Vortex için hız sınırlayıcı middleware'i. Açık API'lere ve/veya parola sıfırlama gibi endpointlere yönelik tekrarlanan istekleri sınırlamak için kullanın.                                    |
| [logger](https://github.com/goVortex/Vortex/tree/master/middleware/logger)               | HTTP istek/yanıt logger'ı.                                                                                                                                                                   |
| [monitor](https://github.com/goVortex/Vortex/tree/master/middleware/monitor)             | Monitor middleware'ı sunucu metriklerini rapor eder, express-status-monitor'den esinlenildi.                                                                                                 |
| [pprof](https://github.com/goVortex/Vortex/tree/master/middleware/pprof)                 | Matthew Lee'ye özel teşekkürler \(@mthli\).                                                                                                                                                  |
| [proxy](https://github.com/goVortex/Vortex/tree/master/middleware/proxy)                 | Birden çok sunucuya proxy istekleri yapmanızı sağlar.                                                                                                                                        |
| [recover](https://github.com/goVortex/Vortex/tree/master/middleware/recover)             | Recover middleware'i, stack chain'ini herhangi bir yerindeki paniklerden kurtulur ve kontrolü merkezileştirilmiş [ErrorHandler'e](https://docs.goVortex.io/guide/error-handling) verir.       |
| [requestid](https://github.com/goVortex/Vortex/tree/master/middleware/requestid)         | Her requeste id verir.                                                                                                                                                                       |
| [session](https://github.com/goVortex/Vortex/tree/master/middleware/session)             | Session için middleware. NOTE: Bu middleware Vortex'in Storage yapısını kullanır.                                                                                                             |
| [skip](https://github.com/goVortex/Vortex/tree/master/middleware/skip)                   | Skip middleware'ı verilen koşul `true` olduğunda handler'ı atlar ve işlemez.                                                                                                                 |
| [timeout](https://github.com/goVortex/Vortex/tree/master/middleware/timeout)             | Bir request için maksimum süre ekler ve aşılırsa ErrorHandler'a iletir.                                                                                                                      |
| [keyauth](https://github.com/goVortex/keyauth)                                          | Key auth middleware, key tabanlı bir authentication sağlar.                                                                                                                                  |
| [redirect](https://github.com/goVortex/redirect)                                        | Yönlendirme middleware 'ı.                                                                                                                                                                   |
| [rewrite](https://github.com/goVortex/rewrite)                                          | Rewrite middleware, sağlanan kurallara göre URL yolunu yeniden yazar. Geriye dönük uyumluluk için veya yalnızca daha temiz ve daha açıklayıcı bağlantılar oluşturmak için yardımcı olabilir. |
| [adaptor](https://github.com/goVortex/adaptor)                                          | Vortex request handlerdan net/http handlerları için dönüştürücü, @arsmn'a özel teşekkürler!                                                                                                   |
| [helmet](https://github.com/goVortex/helmet)                                            | Çeşitli HTTP headerları ayarlayarak uygulamalarınızın güvenliğini sağlamaya yardımcı olur.                                                                                                   |

## 🧬 Harici Middlewarelar

Harici olarak barındırılan middlewareların modüllerinin listesi. Bu middlewarelar, [Vortex ekibi](https://github.com/orgs/goVortex/people) tarafından geliştirilir.

| Middleware                                        | Açıklama                                                                                                                                              |
| :------------------------------------------------ | :---------------------------------------------------------------------------------------------------------------------------------------------------- |
| [jwt](https://github.com/goVortex/jwt)             | JWT, bir JSON Web Token \(JWT\) yetkilendirmesi döndüren middleware.                                                                                  |
| [storage](https://github.com/goVortex/storage)     | Vortex'in Storage yapısını destekleyen birçok storage driver'ı verir. Bu sayede depolama gerektiren Vortex middlewarelarında kolaylıkla kullanılabilir. |
| [template](https://github.com/goVortex/template)   | Bu paket, Vortex `v2.x.x`, Go sürüm 1.17 veya üzeri gerekli olduğunda kullanılabilecek 9 template motoru içerir.                                       |
| [websocket](https://github.com/goVortex/websocket) | Yereller desteğiyle Vortex için Fasthttp WebSocket'a dayalıdır!                                                                                        |

## 🕶️ Awesome Listesi

Daha fazla yazı, middleware, örnek veya araç için [awesome list](https://github.com/goVortex/awesome-Vortex) reposunu kontrol etmeyi unutmayın.

## 👍 Destek

Eğer **teşekkür etmek** veya `Vortex`'ın aktif geliştirilmesini desteklemek istiyorsanız:

1. Projeye [yıldız](https://github.com/goVortex/Vortex/stargazers) verebilirsiniz.
2. [𝕏 (Twitter) hesabınızdan](https://x.com/intent/tweet?text=Vortex%20is%20an%20Express%20inspired%20%23web%20%23framework%20built%20on%20top%20of%20Fasthttp%2C%20the%20fastest%20HTTP%20engine%20for%20%23Go.%20Designed%20to%20ease%20things%20up%20for%20%23fast%20development%20with%20zero%20memory%20allocation%20and%20%23performance%20in%20mind%20%F0%9F%9A%80%20https%3A%2F%2Fgithub.com%2FgoVortex%2FVortex) proje hakkında tweet atabilirsiniz.
...
Vortex; alan adı, gitbook, netlify, serverless yer sağlayıcısı giderleri ve benzeri şeyleri ödemek için bağışlarla yaşayan bir açık kaynaklı projedir. Eğer Vortex'a destek olmak isterseniz, ☕ [**buradan kahve ısmarlayabilirsiniz**](https://buymeacoff.ee/fenny).
...
Telif (c) 2019-günümüz [Fenny](https://github.com/fenny) ve [katkıda bulunanlar](https://github.com/goVortex/Vortex/graphs/contributors). `Vortex`, [MIT Lisansı](https://github.com/goVortex/Vortex/blob/master/LICENSE) altında özgür ve açık kaynaklı bir yazılımdır. Resmî logosu [Vic Shóstak](https://github.com/koddr) tarafından tasarlanmıştır ve [Creative Commons](https://creativecommons.org/licenses/by-sa/4.0/) lisansı altında dağıtımı yapılıyor. (CC BY-SA 4.0 International).
