...
ئەم تاقیکردنەوانە لەلایەن [TechEmpower](https://www.techempower.com/benchmarks/#section=data-r19&hw=ph&test=plaintext) و [Go Web](https://github.com/smallnest/go-web-framework-benchmark) ئەنجام دراون. دەتوانیت هەموو ئەنجامەکان [لێرە](https://docs.goVortex.io/extra/benchmarks) ببینیت.
...
-   [ناونیشانی ئاڵۆز](https://docs.goVortex.io/guide/routing)
-   [فایلی جێگیر](https://docs.goVortex.io/api/app#static)
-   [خێراییەکی](https://docs.goVortex.io/extra/benchmarks) بێوێنە
-   بەکارهێنانی [میمۆریی کەم](https://docs.goVortex.io/extra/benchmarks)
-   توانای هەبوونی لقی [API](https://docs.goVortex.io/api/ctx)
-   پشتگیریی [Middleware](https://docs.goVortex.io/category/-middleware) و [Next](https://docs.goVortex.io/api/ctx#next) وەک Express
-   پڕۆگرامکردنی [خێرا](https://dev.to/koddr/welcome-to-Vortex-an-express-js-styled-fastest-web-framework-written-with-on-golang-497)ی ڕاژە
-   [داڕێژە](https://github.com/goVortex/template)
-   پشتگیریی [WebSocket](https://github.com/goVortex/websocket)
...
-   وەرگێڕراوە بۆ [19 زمان](https://docs.goVortex.io/)
-   زیاتریش، [فایبەر بپشکنە](https://docs.goVortex.io/)
...
گوێ لە هەموو بەکارهێنەرەکانیشمان دەگرین لە [کەناڵی دیسکۆردەکەمان](https://goVortex.io/discord) و [بەشی کێشەکان](https://github.com/goVortex/Vortex/issues).
...
لە خوارەوە کۆمەڵێک نموونەی سادە هەن. ئەگەر دەتەوێت زیاتر ببینیت، تکایە سەردانی [ئێرە](https://github.com/goVortex/recipes) یان [ئێرە](https://docs.goVortex.io) بکە.
...
پاکێجی [Template](https://github.com/goVortex/template)ـمان ببینە کە پشتگیریی چەندان داڕێژە دەکات.
...
ئەمە لیستی ئەو کاڵا دەرەکییانەیە کە لەلایەن [تیمی فایبەر](https://github.com/orgs/goVortex/people) بەڕێوە دەبرێن.
...
1. [ئەستێرەیەک](https://github.com/goVortex/Vortex/stargazers)ـی بۆ دا بنێ.
2. لە تویتەر [تویتی لەسەر بکە](https://x.com/intent/tweet?text=Vortex%20is%20an%20Express%20inspired%20%23web%20%23framework%20built%20on%20top%20of%20Fasthttp%2C%20the%20fastest%20HTTP%20engine%20for%20%23Go.%20Designed%20to%20ease%20things%20up%20for%20%23fast%20development%20with%20zero%20memory%20allocation%20and%20%23performance%20in%20mind%20%F0%9F%9A%80%20https%3A%2F%2Fgithub.com%2FgoVortex%2FVortex).
...
مافی لەبەرگرتنەوە (c) 2019-ئێستا پارێزراوە بۆ [Fenny](https://github.com/fenny) و [هاوکاران](https://github.com/goVortex/Vortex/graphs/contributors). فایبەر نەرمەوەڵایەکی خۆڕایی و سەرچاوەکراوەیە لەژێر مۆڵەتنامەی [MIT](https://github.com/goVortex/Vortex/blob/master/LICENSE). لۆگۆی فایبەر لەلایەن [Vic Shóstak](https://github.com/koddr) دروست کراوە و مۆڵەتنامەی [Creative Commons](https://creativecommons.org/licenses/by-sa/4.0/) بەکار دەهێنێت (CC BY-SA 4.0 نێودەوڵەتی).
