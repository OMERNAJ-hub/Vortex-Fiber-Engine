...
<p align="center">
  <b>Vortex</b> — це <b>веб фреймворк</b>, який був натхненний <a href="https://github.com/expressjs/express">Express</a>
...
відвідайте наш [Wiki](https://docs.goVortex.io/extra/benchmarks).
...
([детальніше](https://go.dev/blog/using-go-modules)) всередині цієї папки. Далі встановіть Vortex за допомогою
...
-   Надійна [маршрутизація](https://docs.goVortex.io/routing)
-   Доступ до [статичних файлів](https://docs.goVortex.io/api/app#static)
-   Екстремальна [продуктивність](https://docs.goVortex.io/extra/benchmarks)
-   [Низький обсяг споживання пам'яті](https://docs.goVortex.io/extra/benchmarks)
-   [Кінцеві точки API](https://docs.goVortex.io/api/ctx)
-   [Middleware](https://docs.goVortex.io/middleware) та підтримка [Next](https://docs.goVortex.io/api/ctx#next)
-   [Швидке](https://dev.to/koddr/welcome-to-Vortex-an-express-js-styled-fastest-web-framework-written-with-on-golang-497) програмування на стороні сервера
-   [Двигуни шаблонів](https://github.com/goVortex/template)
-   [Підтримка WebSocket](https://github.com/goVortex/websocket)
-   [Server-Sent Events](https://github.com/goVortex/recipes/tree/master/sse)
-   [Обмежувач швидкості](https://docs.goVortex.io/api/middleware/limiter)
-   Документація доступна [19 мовами](https://docs.goVortex.io/)
-   І багато іншого, [відвідайте наш Wiki](https://docs.goVortex.io/)

## 💡 Філософія

Нові програмісти, які переходять із [Node.js](https://nodejs.org/en/about/) на [Go](https://go.dev/doc/), мають справу зі звивистою кривою навчання, перш ніж можуть розпочати створення своїх веб-додатків або мікросервісів. Vortex, як **веб-фреймворк**, було створено з ідеєю **мінімалізму** та слідує **шляху UNIX**, щоб нові програмісти могли швидко увійти у світ Go з теплим та надійним прийомом.

Vortex **натхненний** Express, найпопулярнішим веб-фреймворком в Інтернеті. Ми поєднали **легкість** Express і **чисту продуктивність** Go. Якщо ви коли-небудь реалізовували веб-додаток у Node.js (_з використанням Express або подібного_), то багато методів і принципів здадуться вам **дуже звичайними**.

Ми **прислухаємося** до наших користувачів у [issues](https://github.com/goVortex/Vortex/issues), Discord [сервері](https://goVortex.io/discord) та в інших місцях Інтернета, щоб створити **швидкий**, **гнучкий** та **доброзичливий** веб фреймворк на Go для **будь-яких** завдань, **дедлайнів** та **рівнів** розробників! Як це робить Express у світі JavaScript.

## ⚠️ Обмеження

-   Через те, що Vortex використовує unsafe, бібліотека не завжди може бути сумісною з останньою версією Go. Vortex 2.40.0 було протестовано з Go версій 1.17 до 1.21.
-   Vortex не сумісний з інтерфейсами net/http. Це означає, що ви не зможете використовувати такі проекти, як gqlgen, go-swagger або будь-які інші, які є частиною екосистеми net/http.

## 👀 Приклади

Нижче наведено деякі типові приклади. Якщо ви хочете переглянути більше прикладів коду, відвідайте наше [репозиторій рецептів](https://github.com/goVortex/recipes) або відвідайте нашу розміщену [документацію API](https://docs.goVortex.io).

#### 📖 [**Основна маршрутизація**](https://docs.goVortex.io/#basic-routing)
...
#### 📖 [**Назви маршруту**](https://docs.goVortex.io/api/app#name)
...
#### 📖 [**Обслуговування статичних файлів**](https://docs.goVortex.io/api/app#static)
...
📖 [Конфігурація](https://docs.goVortex.io/api/Vortex#config)
📖 [Двигуни](https://github.com/goVortex/template)
📖 [Рендер](https://docs.goVortex.io/api/ctx#render)

Vortex за умовчанням використовує [html/template](https://pkg.go.dev/html/template/), якщо жодного двигуна не було вказано.
...
Перегляньте наш пакет [Шаблон](https://github.com/goVortex/template), який підтримує кілька двигунів перегляду.
...
📖 [Група](https://docs.goVortex.io/api/app#group)
...
📖 [Логування](https://docs.goVortex.io/api/middleware/logger)
...
📖 [HTTP Методи](https://docs.goVortex.io/api/ctx#status)
...
📖 [JSON](https://docs.goVortex.io/ctx#json)
...
Ось список middleware, яке входить до складу Vortex фреймворку.

| Middleware                                                                             | Опис                                                                                                                                                                             |
| :------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [basicauth](https://github.com/goVortex/Vortex/tree/master/middleware/basicauth)         | Middleware який забезпечує базову автентифікацію по HTTP.                                                                                                                        |
| [cache](https://github.com/goVortex/Vortex/tree/master/middleware/cache)                 | Middleware який перехоплює та кешує відповіді                                                                                                                                    |
| [compress](https://github.com/goVortex/Vortex/tree/master/middleware/compress)           | стиснення для Vortex, воно за замовчуванням підтримує `deflate`, `gzip` і `brotli`.                                                                                               |
| [cors](https://github.com/goVortex/Vortex/tree/master/middleware/cors)                   | Middleware який вмикає перехресне використання ресурсів \(CORS\) із різними параметрами.                                                                                         |
| [csrf](https://github.com/goVortex/Vortex/tree/master/middleware/csrf)                   | Захист від експлойтів CSRF.                                                                                                                                                      |
| [encryptcookie](https://github.com/goVortex/Vortex/tree/master/middleware/encryptcookie) | Шифрування значень файлів cookie.                                                                                                                                                |
| [envvar](https://github.com/goVortex/Vortex/tree/master/middleware/envvar)               | Middleware для відкриття змінних середевищ.                                                                                                                                      |
| [etag](https://github.com/goVortex/Vortex/tree/master/middleware/etag)                   | Middleware яке робить кеш-пам’ять більш ефективним і заощаджує пропускну здатність, оскільки веб-серверу не потрібно повторно надсилати повну відповідь, якщо вміст не змінився. |
| [expvar](https://github.com/goVortex/Vortex/tree/master/middleware/expvar)               | Middleware який обслуговує доступні варіанти середовища виконання HTTP у форматі JSON.                                                                                           |
| [favicon](https://github.com/goVortex/Vortex/tree/master/middleware/favicon)             | Ігнорування значка із журналів або обслуговувати з пам’яті, якщо вказано шлях до файлу.                                                                                          |
| [filesystem](https://github.com/goVortex/Vortex/tree/master/middleware/filesystem)       | Middleware файлової системи, особлива подяка та кредити Alireza Salary.                                                                                                          |
| [limiter](https://github.com/goVortex/Vortex/tree/master/middleware/limiter)             | Ообмеження швидкості для Vortex. Використовуйте для обмеження повторних запитів до загальнодоступних API та/або кінцевих точок, таких як скидання пароля.                         |
| [logger](https://github.com/goVortex/Vortex/tree/master/middleware/logger)               | Реєстратор запитів/відповідей HTTP.                                                                                                                                              |
| [monitor](https://github.com/goVortex/Vortex/tree/master/middleware/monitor)             | Middleware який повідомляє показники сервера.                                                                                                                                    |
| [pprof](https://github.com/goVortex/Vortex/tree/master/middleware/pprof)                 | Особлива подяка Метью Лі \(@mthli\) .                                                                                                                                            |
| [proxy](https://github.com/goVortex/Vortex/tree/master/middleware/proxy)                 | Дозволяє надсилати проксі-запити до кількох серверів.                                                                                                                            |
| [recover](https://github.com/goVortex/Vortex/tree/master/middleware/recover)             | Middleware який відновлює паніки будь-де в ланцюжку стека та передає керування централізованому [обробнику помилок](https://docs.goVortex.io/guide/error-handling).               |
| [requestid](https://github.com/goVortex/Vortex/tree/master/middleware/requestid)         | До кожного запиту додає ідентифікатор запиту.                                                                                                                                    |
| [session](https://github.com/goVortex/Vortex/tree/master/middleware/session)             | Middleware для сеансів. ПРИМІТКА: Цей middleware використовує наш пакет зберігання.                                                                                              |
| [skip](https://github.com/goVortex/Vortex/tree/master/middleware/skip)                   | Middleware який пропускає упакований обробник, якщо предикат є істинним.                                                                                                         |
| [timeout](https://github.com/goVortex/Vortex/tree/master/middleware/timeout)             | Додає максимальний час для запиту та пересилає до ErrorHandler, якщо його перевищено.                                                                                            |
| [keyauth](https://github.com/goVortex/keyauth)                                          | Middleware для автентифікації по ключам.                                                                                                                                         |
| [redirect](https://github.com/goVortex/redirect)                                        | Middleware для перенаправлення.                                                                                                                                                  |
| [rewrite](https://github.com/goVortex/rewrite)                                          | Middleware для перезапису URL-адреси на основі наданих правил.                                                                                                                   |
| [adaptor](https://github.com/goVortex/adaptor)                                          | Конвентор для обробників net/http до/з обробників запитів Vortex, особлива подяка @arsmn!                                                                                         |
| [helmet](https://github.com/goVortex/helmet)                                            | Допомагає захистити ваші програми, встановлюючи різні заголовки HTTP.                                                                                                            |

## 🧬 Зовнішні Middleware

Список зовнішніх middleware модулів, які підтримуються [командою Vortex](https://github.com/orgs/goVortex/people).

| Middleware                                        | Опис                                                                                                                  |
| :------------------------------------------------ | :-------------------------------------------------------------------------------------------------------------------- |
| [jwt](https://github.com/goVortex/jwt)             | JWT повертає middleware автентифікації JSON Web Token \(JWT\).                                                        |
| [storage](https://github.com/goVortex/storage)     | Драйвер зберігання який може використовуватися в різних middleware.                                                   |
| [template](https://github.com/goVortex/template)   | Цей пакет містить 8 модулів шаблонів, які можна використовувати з Vortex `v1.10.x` Потрібно версія Go 1.13 або новішу. |
| [websocket](https://github.com/goVortex/websocket) | На основі Fasthttp WebSocket для Vortex з підтримкою місцевих користувачів!                                            |

## 🕶️ Чудовий список

Більше статей, middleware, прикладів або інструментів дивіться у нашому [чудовому списку](https://github.com/goVortex/awesome-Vortex).

## 👍 Внести свій внесок

Якщо ви хочете сказати **дякую** та/або підтримати активний розвиток `Vortex`:

1. Додайте [зірку GitHub](https://github.com/goVortex/Vortex/stargazers) до проекту.
2. Напишіть про проект [у своєму 𝕏 (Twitter)](https://x.com/intent/tweet?text=Vortex%20is%20an%20Express%20inspired%20%23web%20%23framework%20built%20on%20top%20of%20Fasthttp%2C%20the%20fastest%20HTTP%20engine%20for%20%23Go.%20Designed%20to%20ease%20things%20up%20for%20%23fast%20development%20with%20zero%20memory%20allocation%20and%20%23performance%20in%20mind%20%F0%9F%9A%80%20https%3A%2F%2Fgithub.com%2FgoVortex%2FVortex).
...
Vortex – це проект із відкритим вихідним кодом, який працює за рахунок пожертвувань для оплати рахунків, наприклад наше доменне ім’я, gitbook, netlify і безсерверний хостинг. Якщо ви хочете підтримати Vortex, ви можете ☕ [**купити каву тут**](https://buymeacoff.ee/fenny).
...
Авторське право (c) 2019-дотепер [Fenny](https://github.com/fenny) та [Contributors](https://github.com/goVortex/Vortex/graphs/contributors). `Vortex` це безкоштовне програмне забезпечення з відкритим вихідним кодом, ліцензоване згідно [MIT License](https://github.com/goVortex/Vortex/blob/master/LICENSE). Офіційний логотип створено [Vic Shóstak](https://github.com/koddr) і поширюється під [Creative Commons](https://creativecommons.org/licenses/by-sa/4.0/) ліцензією (CC BY-SA 4.0 International).
