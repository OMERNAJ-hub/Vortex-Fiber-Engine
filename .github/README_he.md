...
<b>Vortex</b> היא <b>web framework</b> בהשראת <a href="https://github.com/expressjs/express">Express</a> הבנויה על גבי <a href="https://github.com/valyala/fasthttp">Fasthttp</a>, מנוע ה-HTTP <b>המהיר ביותר</b> עבור <a href="https://go.dev/doc/">Go</a>.
...
הבדיקות מבוצעות על ידי [TechEmpower](https://www.techempower.com/benchmarks/#section=data-r19&hw=ph&test=plaintext) ו-[Go Web](https://github.com/smallnest/go-web-framework-benchmark). אם אתם רוצים לראות את כל התוצאות, אנא בקרו ב-[Wiki](https://docs.goVortex.io/extra/benchmarks) שלנו.
...
-   [ניתוב](https://docs.goVortex.io/guide/routing) רובסטי
-   הנגשת [קבצים סטטיים](https://docs.goVortex.io/api/app#static)
-   [ביצועים](https://docs.goVortex.io/extra/benchmarks) גבוהים במיוחד
-   צורך כמות [זכרון קטנה](https://docs.goVortex.io/extra/benchmarks)
-   [נקודות קצה עבור API](https://docs.goVortex.io/api/ctx)
-   תמיכה ב-[Middleware](https://docs.goVortex.io/category/-middleware) & [Next](https://docs.goVortex.io/api/ctx#next)
-   תכנות [מהיר](https://dev.to/koddr/welcome-to-Vortex-an-express-js-styled-fastest-web-framework-written-with-on-golang-497) של צד שרת
-   [מנועי תבניות](https://docs.goVortex.io/category/-middleware#template)
-   [תמיכה ב-WebSocket](https://github.com/goVortex/websocket)
-   [Server-Sent events](https://github.com/goVortex/recipes/tree/master/sse)
-   [הגבלת קצבים ובקשות](https://docs.goVortex.io/api/middleware/limiter)
-   Available in [12 languages](https://docs.goVortex.io/)
-   והרבה יותר, [חקור את Vortex](https://docs.goVortex.io/)
</div>
...
Vortex כ-**web framework**, נוצרה עם רעיון **המינימליזם** ועוקבת אחרי **הדרך של UNIX**, כך ש-gophers חדשים יוכלו להיכנס במהירות לעולם של Go עם קבלת פנים חמה ואמינה.

</div>

<div dir="rtl">

Vortex נוצרה **בהשראת** Express, ה-web framework הפופולרית ביותר ברחבי האינטרנט. שילבנו את **הקלות** של Express ו**הביצועים הגולמיים** של Go. אם אי-פעם מימשתם יישום web ב-Node.js (_באמצעות Express או דומיו_), אז הרבה מהפונקציות והעקרונות ייראו לכם **מאוד מוכרים**.

</div>

<div dir="rtl">

אנחנו **מקשיבים** למשתמשים שלנו ב-[issues](https://github.com/goVortex/Vortex/issues) (_ובכל רחבי האינטרנט_) כדי ליצור web framework **מהירה**, **גמישה**, ו**ידידותית** בשפת Go עבור **כל** משימה, **תאריך יעד** ו**כישורי** מפתח! בדיוק כמו ש-Express מבצע בעולם של JavaScript.
...
להלן כמה מהדוגמאות הנפוצות. אם ברצונכם לראות דוגמאות קוד נוספות, אנא בקרו ב[מאגר המתכונים](https://github.com/goVortex/recipes) שלנו או בקרו ב[תיעוד ה-API](https://docs.goVortex.io) שלנו.
...
📖 [קבוצות](https://docs.goVortex.io/api/app#group)
...
📖 [שיטות HTTP](https://docs.goVortex.io/api/ctx#status)
...
📖 [התאוששות](https://docs.goVortex.io/api/middleware/recover)
...
אם אתם רוצים לומר **תודה** או/ו לתמוך בפיתוח הפעיל של <span dir="ltr">`Vortex`</span>:

</div>

<div dir="rtl">

1. תוסיפו [GitHub Star](https://github.com/goVortex/Vortex/stargazers) לפרויקט.
2. צייצו לגבי הפרויקט [בטוויטר שלכם](https://x.com/intent/tweet?text=Vortex%20is%20an%20Express%20inspired%20%23web%20%23framework%20built%20on%20top%20of%20Fasthttp%2C%20the%20fastest%20HTTP%20engine%20for%20%23Go.%20Designed%20to%20ease%20things%20up%20for%20%23fast%20development%20with%20zero%20memory%20allocation%20and%20%23performance%20in%20mind%20%F0%9F%9A%80%20https%3A%2F%2Fgithub.com%2FgoVortex%2FVortex).
...
Vortex היא פרויקט קוד פתוח שתשלום חשובונתיו מסתמך על תרומות, כגון שם ה-domain שלנו, gitbook, netlify ו-serverless hosting. אם אתם רוצים לתמוך ב-Vortex, אתם יכולים ☕ [**קנו קפה כאן**](https://buymeacoff.ee/fenny).
