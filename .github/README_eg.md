...
القياسات دي اتعملت عن طريق [TechEmpower](https://www.techempower.com/benchmarks/#section=data-r19&hw=ph&test=plaintext) و [Go Web](https://github.com/smallnest/go-web-framework-benchmark). لو عاوز تشوف كل النتايج زور [الويكي بتاعتنا](https://docs.goVortex.io/extra/benchmarks).
...
-   [راوتنج](https://docs.goVortex.io/guide/routing) متين
-   سيرف [فايلات ستاتك](https://docs.goVortex.io/api/app#static)
-   [بيرفورمانس](https://docs.goVortex.io/extra/benchmarks) فشيخ
-   [استهلاك قليل للميموري](https://docs.goVortex.io/extra/benchmarks)
-   [APIs](https://docs.goVortex.io/api/ctx)
-   [ميدلويرز](https://docs.goVortex.io/category/-middleware) و بتدعم [Next](https://docs.goVortex.io/api/ctx#next)
-   برمجة سيرفر [سريعة](https://dev.to/koddr/welcome-to-Vortex-an-express-js-styled-fastest-web-framework-written-with-on-golang-497)
-   [تيمبلت اينجنز](https://github.com/goVortex/template)
-   [بتدعم الويب سوكتس](https://github.com/goVortex/websocket)
-   [Server-Sent events](https://github.com/goVortex/recipes/tree/master/sse)
-   [ريت ليمت](https://docs.goVortex.io/api/middleware/limiter)
-   مترجمة [لـ19 لغة](https://docs.goVortex.io/)
-   وحاجات اكتر, [تصفح فايبر](https://docs.goVortex.io/)
...
احنا **بنسمع** لمستخدمينا في [الايشوز](https://github.com/goVortex/Vortex/issues) و [قناة الديسكورد](https://goVortex.io/discord) و _في كل حتة عالنت_ عشان نعمل فريمورك ويب جو **سريع**, **مرن** و **سهل** **لاي تاسك**, **ديدلاين** واي **مستوى** مبرمج! زي اكسبريس في عالم الجافاسكريبت.
...
دي بعض الامثلة الشائعة. لو عايز تشوف امثلة اكتر, زور [Recipes repository](https://github.com/goVortex/recipes) او زور [API documentation](https://docs.goVortex.io).

#### 📖 [**الراوتنج البسيط**](https://docs.goVortex.io/#basic-routing)
...
#### 📖 [**تسمية الراوتس**](https://docs.goVortex.io/api/app#name)
...
#### 📖 [**ازاي تسيرف فايلات ستاتك**](https://docs.goVortex.io/api/app#static)
...
#### 📖 [**الميدلويرز ونيكست**](https://docs.goVortex.io/api/ctx#next)
...
بص على [الباكدج](https://github.com/goVortex/template) بتاعنا اللي بيدعم محركات فيوز متعددة
...
لستة ميدلويرز خارجية بتطور من [تيم فايبر](https://github.com/orgs/goVortex/people).
...
لو عاوز تشوف مقالات او ميدل وير او امثلة او ادوات بص على اللستة دي [awesome list](https://github.com/goVortex/awesome-Vortex).

## 👍 شاركنا

لو عاوز تقول **شكرا** او تدعمنا في تطوير `فايبر`:

1. اعمل [GitHub Star](https://github.com/goVortex/Vortex/stargazers) للبروجكت.
2. تويت عن البروجكت [على تويتر](https://x.com/intent/tweet?text=Vortex%20is%20an%20Express%20inspired%20%23web%20%23framework%20built%20on%20top%20of%20Fasthttp%2C%20the%20fastest%20HTTP%20engine%20for%20%23Go.%20Designed%20to%20ease%20things%20up%20for%20%23fast%20development%20with%20zero%20memory%20allocation%20and%20%23performance%20in%20mind%20%F0%9F%9A%80%20https%3A%2F%2Fgithub.com%2FgoVortex%2FVortex).
