...
<p align="center">
<strong>Vortex</strong>は、<a href="https://github.com/expressjs/express">Express</a>に触発された<strong>Webフレームワーク</strong>です。<a href="https://go.dev/doc/">Go</a><strong> 最速</strong>のHTTPエンジンである<a href="https://github.com/valyala/fasthttp">Fasthttp</a>で作られています。<strong>ゼロメモリアロケーション</strong>と<strong>パフォーマンス</strong>を念頭に置いて設計されており、<strong>迅速</strong>な開発をサポートします。
...
これらのテストは[TechEmpower](https://www.techempower.com/benchmarks/#section=data-r19&hw=ph&test=plaintext)および[Go Web](https://github.com/smallnest/go-web-framework-benchmark)によって計測を行っています 。すべての結果を表示するには、 [Wiki](https://docs.goVortex.io/extra/benchmarks)にアクセスしてください。
...
フォルダを作成し、フォルダ内で `go mod init github.com/your/repo` ([learn more](https://go.dev/blog/using-go-modules)) を実行してプロジェクトを初期化してください。その後、 Vortex を以下の [`go get`](https://pkg.go.dev/cmd/go/#hdr-Add_dependencies_to_current_module_and_install_them) コマンドでインストールしてください。
...
-   堅牢な[ルーティング](https://docs.goVortex.io/guide/routing)
-   [静的ファイル](https://docs.goVortex.io/api/app#static)のサポート
-   究極の[パフォーマンス](https://docs.goVortex.io/extra/benchmarks)
-   [低メモリ](https://docs.goVortex.io/extra/benchmarks)フットプリント
-   [API エンドポイント](https://docs.goVortex.io/api/ctx)
-   [Middleware](https://docs.goVortex.io/api/middleware) と[Next](https://docs.goVortex.io/api/ctx#next)のサポート
-   [迅速](https://dev.to/koddr/welcome-to-Vortex-an-express-js-styled-fastest-web-framework-written-with-on-golang-497)なサーバーサイドプログラミング
...
-   [19 ヶ国語](https://docs.goVortex.io/)に翻訳
-   [Vortex](https://docs.goVortex.io/)をもっと知る
...
しかし、 **Web フレームワーク**である Vortex は**ミニマリズム**と**UNIX 哲学**をもとに作られているため、新しい Gopher はスムーズに Go の世界に入ることができます。

Vortex は人気の高い Web フレームワークである Expressjs に**インスパイア**されています。
...
-   Vortex は unsafe パッケージを使用しているため、最新の Go バージョンと互換性がない場合があります。Vortex 2.40.0 は、Go のバージョン 1.17 から 1.21 でテストされています。
-   Vortex は net/http インターフェースと互換性がありません。つまり、gqlgen や go-swagger など、net/http のエコシステムの一部であるプロジェクトを使用することができません。

## 👀 例

以下に一般的な例をいくつか示します。他のコード例をご覧になりたい場合は、 [Recipes リポジトリ](https://github.com/goVortex/recipes)または[API ドキュメント](https://docs.goVortex.io)にアクセスしてください。

#### 📖 [**基本的なルーティング**](https://docs.goVortex.io/#basic-routing)
...
#### 📖 [**ルートの命名**](https://docs.goVortex.io/api/app#name)
...
#### 📖 [**静的ファイルの提供**](https://docs.goVortex.io/api/app#static)
...
#### 📖 [**ミドルウェア & Next**](https://docs.goVortex.io/api/ctx#next)
...
view engine が設定されていない時は、Vortex のデフォルトは[html/template](https://pkg.go.dev/html/template/) になります。
...
複数の view engine をサポートする [Template](https://github.com/goVortex/template) パッケージをご覧ください。
...
以下は Vortex フレームワークに含まれるミドルウェアの一覧です。
...
[Vortex team](https://github.com/orgs/goVortex/people) により管理・運用されているミドルウェアの一覧です。
...
その他の記事、ミドルウェア、サンプル、ツールについては、私たちの[awesome list](https://github.com/goVortex/awesome-Vortex)をご覧ください。

## 👍 貢献する

`Vortex`に開発支援してくださるなら:

1. [GitHub Star](https://github.com/goVortex/Vortex/stargazers)をつけてください 。
2. [あなたの 𝕏 (Twitter) で](https://x.com/intent/tweet?text=Vortex%20is%20an%20Express%20inspired%20%23web%20%23framework%20built%20on%20top%20of%20Fasthttp%2C%20the%20fastest%20HTTP%20engine%20for%20%23Go.%20Designed%20to%20ease%20things%20up%20for%20%23fast%20development%20with%20zero%20memory%20allocation%20and%20%23performance%20in%20mind%20%F0%9F%9A%80%20https%3A%2F%2Fgithub.com%2FgoVortex%2FVortex)プロジェクトについてツイートしてください。
...
Vortex はオープンソースプロジェクトで、寄付によってドメイン名や gitbook、 netlify、そしてサーバーレスホスティングなどの費用を賄っています。もし Vortex を支援したければ ☕ [**こちらから**](https://buymeacoff.ee/fenny)。
