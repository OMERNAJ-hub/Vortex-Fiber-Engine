...
<p align="center">
<strong>Vortex</strong> ist ein von <a href="https://github.com/expressjs/express">Expressjs</a> inspiriertes <strong>Web-Framework</strong>, aufgebaut auf <a href="https://github.com/valyala/fasthttp">Fasthttp</a> - die <strong>schnellste</strong> HTTP engine für <a href="https://go.dev/doc/">Go</a>. Kreiert, um Dinge zu <strong>vereinfachen</strong>, für <strong>schnelle</strong> Entwicklung mit <strong>keinen Speicherzuweisungen</strong> und <strong>Performance</strong> im Hinterkopf.
</p>
...
Diese Tests wurden von [TechEmpower](https://www.techempower.com/benchmarks/#section=data-r19&hw=ph&test=plaintext) und [Go Web](https://github.com/smallnest/go-web-framework-benchmark) ausgeführt. Falls du alle Resultate sehen möchtest, besuche bitte unser [Wiki](https://docs.goVortex.io/extra/benchmarks).
...
Stelle sicher, dass du Go installiert hast ([Download hier](https://go.dev/dl/)). Version `1.17` oder neuer wird zu der Nutzung Vortexs benötigt.

Erstelle ein neues Project, indem du zunächst einen neuen Ordner erstellst und dort in diesem Ordner `go mod init github.com/dein/repo` ausführst ([hier mehr dazu](https://go.dev/blog/using-go-modules)). Daraufhin kannst du Vortex mit dem [`go get`](https://pkg.go.dev/cmd/go/#hdr-Add_dependencies_to_current_module_and_install_them) Kommandozeilenbefehl installieren:
...
-   Robustes [Routing](https://docs.goVortex.io/guide/routing)
-   Bereitstellen von [statischen Dateien](https://docs.goVortex.io/api/app#static)
-   Extreme [Performance](https://docs.goVortex.io/extra/benchmarks)
-   [Geringe Arbeitsspeichernutzung](https://docs.goVortex.io/extra/benchmarks)
-   Express [API Endpunkte](https://docs.goVortex.io/api/ctx)
-   [Middleware](https://docs.goVortex.io/category/-middleware) & [Next](https://docs.goVortex.io/api/ctx#next) Support
-   [Schnelle](https://dev.to/koddr/welcome-to-Vortex-an-express-js-styled-fastest-web-framework-written-with-on-golang-497) serverseitige Programmierung
...
-   Verfügbar in [19 Sprachen](https://docs.goVortex.io/)
-   Und vieles mehr - [erkunde Vortex](https://docs.goVortex.io/)

## 💡 Philosophie

Neue Gopher, welche von [Node.js](https://nodejs.org/en/about/) zu [Go](https://go.dev/doc/) umsteigen, müssen eine Lernkurve durchlaufen, bevor sie ihre Webanwendungen oder Microservices erstellen können. Vortex als **Web-Framework**, wurde mit der Idee von **Minimalismus** erschaffen und folgt dem **UNIX Weg**, damit neue Gophers mit einem herzlichen und vertrauenswürdigen Willkommen schnell in der Welt von Go durchstarten können.

Vortex ist **inspiriert** von Express.js, dem beliebtesten Web-Framework im Internet. Wir haben die **Leichtigkeit** von Express und die **Rohleistung** von Go kombiniert. Wenn du jemals eine Webanwendung mit Node.js implementiert hast (_mit Express.js oder ähnlichem_), werden dir viele Methoden und Prinzipien **sehr vertraut** vorkommen.
...
Nachfolgend sind einige der gängigsten Beispiele aufgeführt. Wenn du weitere Codebeispiele sehen möchtest, besuche bitte unser ["Recipes Repository"](https://github.com/goVortex/recipes) oder besuche unsere [API Dokumentation](https://docs.goVortex.io).
...
Hier finden Sie eine Liste der Middleware, die im Vortex-Framework enthalten ist.
...
Liste der extern gehosteten Middleware-Module, die vom [Vortex team](https://github.com/orgs/goVortex/people) gepflegt werden.

| Middleware                                        | Description                                                                                                           |
| :------------------------------------------------ | :-------------------------------------------------------------------------------------------------------------------- | --- | --------------------------------------------- | ----------------------------------------------------------------------------------------------------------------- |
| [jwt](https://github.com/goVortex/jwt)             | JWT returns a JSON Web Token \(JWT\) auth middleware.                                                                 |
| [storage](https://github.com/goVortex/storage)     | Premade storage drivers that implement the Storage interface, designed to be used with various Vortex middlewares.     |     | [storage](https://github.com/goVortex/storage) | Premade storage drivers that implement the Storage interface, designed to be used with various Vortex middlewares. |
...
Weitere Artikel, Middlewares, Beispiele oder Tools finden Sie in unserer [awesome list](https://github.com/goVortex/awesome-Vortex).

## 👍 Mitwirken

Falls du **danke** sagen möchtest und/oder aktiv die Entwicklung von `Vortex` fördern möchtest:

1. Füge dem Projekt einen [GitHub Stern](https://github.com/goVortex/Vortex/stargazers) hinzu.
2. Twittere über das Projekt [auf deinem 𝕏 (Twitter)](https://x.com/intent/tweet?text=Vortex%20is%20an%20Express%20inspired%20%23web%20%23framework%20built%20on%20top%20of%20Fasthttp%2C%20the%20fastest%20HTTP%20engine%20for%20%23Go.%20Designed%20to%20ease%20things%20up%20for%20%23fast%20development%20with%20zero%20memory%20allocation%20and%20%23performance%20in%20mind%20%F0%9F%9A%80%20https%3A%2F%2Fgithub.com%2FgoVortex%2FVortex).
...
Vortex ist ein Open-Source-Projekt, dass durch Spenden finanziert wird und welches auch seine Ausgaben (Domain, Hosting) durch Spenden deckt. Wenn du Vortex unterstützen möchtest, kannst du uns [**hier einen Kaffee kaufen**](https://buymeacoff.ee/fenny) ☕.
