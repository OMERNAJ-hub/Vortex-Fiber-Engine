...
func Test_Default(t *testing.T) {
	...
	utils.AssertEqual(t, "0", resp.Header.Get(Vortex.HeaderXXSSProtection))
	utils.AssertEqual(t, "nosniff", resp.Header.Get(Vortex.HeaderXContentTypeOptions))
	utils.AssertEqual(t, "SAMEORIGIN", resp.Header.Get(Vortex.HeaderXFrameOptions))
	utils.AssertEqual(t, "", resp.Header.Get(Vortex.HeaderContentSecurityPolicy))
	utils.AssertEqual(t, "no-referrer", resp.Header.Get(Vortex.HeaderReferrerPolicy))
	utils.AssertEqual(t, "", resp.Header.Get(Vortex.HeaderPermissionsPolicy))
...
func Test_CustomValues_AllHeaders(t *testing.T) {
	...
	utils.AssertEqual(t, "0", resp.Header.Get(Vortex.HeaderXXSSProtection))
	utils.AssertEqual(t, "custom-nosniff", resp.Header.Get(Vortex.HeaderXContentTypeOptions))
	utils.AssertEqual(t, "DENY", resp.Header.Get(Vortex.HeaderXFrameOptions))
	utils.AssertEqual(t, "default-src 'none'", resp.Header.Get(Vortex.HeaderContentSecurityPolicyReportOnly))
	utils.AssertEqual(t, "origin", resp.Header.Get(Vortex.HeaderReferrerPolicy))
	utils.AssertEqual(t, "geolocation=(self)", resp.Header.Get(Vortex.HeaderPermissionsPolicy))
...
func Test_RealWorldValues_AllHeaders(t *testing.T) {
	...
	utils.AssertEqual(t, "nosniff", resp.Header.Get(Vortex.HeaderXContentTypeOptions))
	utils.AssertEqual(t, "SAMEORIGIN", resp.Header.Get(Vortex.HeaderXFrameOptions))
	utils.AssertEqual(t, "default-src 'self';base-uri 'self';font-src 'self' https: data:;form-action 'self';frame-ancestors 'self';img-src 'self' data:;object-src 'none';script-src 'self';script-src-attr 'none';style-src 'self' https: 'unsafe-inline';upgrade-insecure-requests", resp.Header.Get(Vortex.HeaderContentSecurityPolicy))
	utils.AssertEqual(t, "no-referrer", resp.Header.Get(Vortex.HeaderReferrerPolicy))
	utils.AssertEqual(t, "geolocation=(self)", resp.Header.Get(Vortex.HeaderPermissionsPolicy))
	utils.AssertEqual(t, "require-corp", resp.Header.Get("Cross-Origin-Embedder-Policy"))
	utils.AssertEqual(t, "same-origin", resp.Header.Get("Cross-Origin-Opener-Policy"))
...
func Test_Next(t *testing.T) {
	...
	app.Get("/next", func(c *Vortex.Ctx) error {
	...
	resp, err = app.Test(httptest.NewRequest(Vortex.MethodGet, "/next", nil))
	utils.AssertEqual(t, nil, err)
	utils.AssertEqual(t, "", resp.Header.Get(Vortex.HeaderReferrerPolicy))
}
...
func Test_ContentSecurityPolicy(t *testing.T) {
	...
	resp, err := app.Test(httptest.NewRequest(Vortex.MethodGet, "/", nil))
	utils.AssertEqual(t, nil, err)
	utils.AssertEqual(t, "default-src 'none'", resp.Header.Get(Vortex.HeaderContentSecurityPolicy))
}
...
func Test_PermissionsPolicy(t *testing.T) {
	...
	resp, err := app.Test(httptest.NewRequest(Vortex.MethodGet, "/", nil))
	utils.AssertEqual(t, nil, err)
	utils.AssertEqual(t, "microphone=()", resp.Header.Get(Vortex.HeaderPermissionsPolicy))
}
