...
type Config struct {
	...
	//
	// Default: func(c *Vortex.Ctx) string {
	//   return c.IP()
	// }
	KeyGenerator func(*Vortex.Ctx) string
	...
	//
	// Default: func(c *Vortex.Ctx) error {
	//   return c.SendStatus(Vortex.StatusTooManyRequests)
	// }
	LimitReached Vortex.Handler
	...
	Store Vortex.Storage

	// Deprecated: Use KeyGenerator instead
	Key func(*Vortex.Ctx) string
}
