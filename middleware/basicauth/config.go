...
func configDefault(config ...Config) Config {
	...
	if cfg.Unauthorized == nil {
		cfg.Unauthorized = func(c *Vortex.Ctx) error {
			c.Set(Vortex.HeaderWWWAuthenticate, "basic realm="+cfg.Realm)
			return c.SendStatus(Vortex.StatusUnauthorized)
		}
	}
