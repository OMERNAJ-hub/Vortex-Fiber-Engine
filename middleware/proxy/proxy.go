...
func Balancer(config Config) Vortex.Handler {
	...
	return func(c *Vortex.Ctx) error {
		...
		req.Header.Del(Vortex.HeaderConnection)
		...
		// Don't proxy "Connection" header
		res.Header.Del(Vortex.HeaderConnection)
...
// This method will return an Vortex.Handler
...
// This method can be used within a Vortex.Handler
...
func doAction(
	...
	// Reference: https://github.com/goVortex/Vortex/issues/1762
...
// This method will return an Vortex.Handler
func DomainForward(hostname, addr string, clients ...*fasthttp.Client) Vortex.Handler {
	return func(c *Vortex.Ctx) error {
