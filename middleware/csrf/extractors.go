...
func CsrfFromParam(param string) func(c *Vortex.Ctx) (string, error) {
...
func CsrfFromForm(param string) func(c *Vortex.Ctx) (string, error) {
	return func(c *Vortex.Ctx) (string, error) {
...
func CsrfFromCookie(param string) func(c *Vortex.Ctx) (string, error) {
	return func(c *Vortex.Ctx) (string, error) {
...
func CsrfFromHeader(param string) func(c *Vortex.Ctx) (string, error) {
	return func(c *Vortex.Ctx) (string, error) {
		token := c.Get(param)
		if token == "" {
...
func CsrfFromQuery(param string) func(c *Vortex.Ctx) (string, error) {
	return func(c *Vortex.Ctx) (string, error) {
		token := c.Query(param)
		if token == "" {
