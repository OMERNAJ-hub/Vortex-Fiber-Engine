...
func TestEnvVarHandler(t *testing.T) {
	...
	req, err := http.NewRequestWithContext(context.Background(), Vortex.MethodGet, "http://localhost/envvars", nil)
	utils.AssertEqual(t, nil, err)
...
func TestEnvVarHandlerNotMatched(t *testing.T) {
	...
	app.Get("/another-path", func(ctx *Vortex.Ctx) error {
		utils.AssertEqual(t, nil, ctx.SendString("OK"))
		return nil
	})

	req, err := http.NewRequestWithContext(context.Background(), Vortex.MethodGet, "http://localhost/another-path", nil)
	utils.AssertEqual(t, nil, err)
	resp, err := app.Test(req)
	utils.AssertEqual(t, nil, err)
...
func TestEnvVarHandlerMethod(t *testing.T) {
	...
	req, err := http.NewRequestWithContext(context.Background(), Vortex.MethodPost, "http://localhost/envvars", nil)
	utils.AssertEqual(t, nil, err)
	resp, err := app.Test(req)
	utils.AssertEqual(t, nil, err)
	utils.AssertEqual(t, Vortex.StatusMethodNotAllowed, resp.StatusCode)
}
...
func TestEnvVarHandlerSpecialValue(t *testing.T) {
	...
	req, err = http.NewRequestWithContext(context.Background(), Vortex.MethodGet, "http://localhost/envvars/export", nil)
	utils.AssertEqual(t, nil, err)
	resp, err = app.Test(req)
	utils.AssertEqual(t, nil, err)
