...
import (
  ...
  "github.com/goVortex/Vortex/v2/middleware/basicauth"
)
```
...
app.Use(basicauth.New(basicauth.Config{
    ...
    Unauthorized: func(c *Vortex.Ctx) error {
...
| Unauthorized    | `Vortex.Handler`             | Unauthorized defines the response body for unauthorized responses.                                                                                                    | `nil`                 |
