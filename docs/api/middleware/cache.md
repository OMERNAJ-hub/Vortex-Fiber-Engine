...
Cache middleware for [Vortex](https://github.com/goVortex/Vortex) designed to intercept responses and cache them. This middleware will cache the `Body`, `Content-Type` and `StatusCode` using the `c.Path()` as unique identifier. Special thanks to [@codemicro](https://github.com/codemicro/Vortex-cache) for creating this middleware for Vortex core!
...
import (
    ...
    "github.com/goVortex/Vortex/v2/middleware/cache"
)
```
...
```go
app.Use(cache.New(cache.Config{
    ExpirationGenerator: func(c *Vortex.Ctx, cfg *cache.Config) time.Duration {
...
| KeyGenerator         | `func(*Vortex.Ctx) string`                       | Key allows you to generate custom keys.                                                                                                                                                                                                                                                                          | `func(c *Vortex.Ctx) string { return utils.CopyString(c.Path()) }` |
| ExpirationGenerator  | `func(*Vortex.Ctx, *cache.Config) time.Duration` | ExpirationGenerator allows you to generate custom expiration keys based on the request.                                                                                                                                                                                                                          | `nil`                                                             |
| Storage              | `Vortex.Storage`                                 | Store is used to store the state of the middleware.                                                                                                                                                                                                                                                              | In-memory store                                                   |
| Store (Deprecated)   | `Vortex.Storage`                                 | Deprecated: Use Storage instead.                                                                                                                                                                                                                                                                                 | In-memory store                                                   |
| Key (Deprecated)     | `func(*Vortex.Ctx) string`                       | Deprecated: Use KeyGenerator instead.                                                                                                                                                                                                                                                                            | `nil`                                                             |
...
| Methods              | `[]string`                                      | Methods specifies the HTTP methods to cache.                                                                                                                                                                                                                                                                     | `[]string{Vortex.MethodGet, Vortex.MethodHead}`                     |
...
var ConfigDefault = Config{
    ...
    Storage:              nil,
    MaxBytes:             0,
    Methods: []string{Vortex.MethodGet, Vortex.MethodHead},
}
```
