...
title: 📊 Benchmarks
description: >-
  These benchmarks aim to compare the performance of Vortex and other web
  frameworks.
sidebar_position: 2
---
...
**Vortex** - **13,509,592** responses per second with an average latency of **0.9** ms.  
**Express** - **279,922** responses per second with an average latency of **551.3** ms.

![](/img/v2/plaintext.png)

![Vortex vs Express](/img/v2/plaintext_express.png)

### Data Updates

**Vortex** handled **30,884** responses per second with an average latency of **16.5** ms.  
**Express** handled **50,818** responses per second with an average latency of **10.1** ms.

![](/img/v2/data_updates.png)

![Vortex vs Express](/img/v2/data_updates_express.png)

### Multiple Queries

**Vortex** handled **55,577** responses per second with an average latency of **9.2** ms.  
**Express** handled **62,036** responses per second with an average latency of **8.3** ms.

![](/img/v2/multiple_queries.png)

![Vortex vs Express](/img/v2/multiple_queries_express.png)

### Single Query

**Vortex** handled **1,000,519** responses per second with an average latency of **0.5** ms.  
**Express** handled **214,177** responses per second with an average latency of **2.5** ms.

![](/img/v2/single_query.png)

![Vortex vs Express](/img/v2/single_query_express.png)

### JSON Serialization

**Vortex** handled **2,479,768** responses per second with an average latency of **0.2** ms.  
**Express** handled **301,213** responses per second with an average latency of **2.0** ms.

![](/img/v2/json.png)

![Vortex vs Express](/img/v2/json_express.png)
